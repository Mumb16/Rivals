...
namespace Rivals.Common.Systems
{
	...
	public class DownedShadeBoss : ModSystem
	{
		public static bool downedShadeBoss = false;
		// public static bool downedOtherBoss = false;

		public override void OnWorldLoad()
		{
			downedShadeBoss = false;
		...
		{
			downedShadeBoss = tag.ContainsKey("downedShadeBoss");
