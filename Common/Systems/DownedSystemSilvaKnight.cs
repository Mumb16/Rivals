...
namespace Rivals.Common.Systems
{
	...
	public class DownedSystemSilvaKnight : ModSystem
	{
		public static bool downedSilvaKnight = false;
		// public static bool downedOtherBoss = false;

		public override void OnWorldLoad()
		{
			downedSilvaKnight = false;
		...
		{
			if (downedSilvaKnight)
			{
				tag["downedSilvaKnight"] = true;
			}
		...
		{
			downedSilvaKnight = tag.ContainsKey("downedSilvaKnight");
