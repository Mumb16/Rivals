...
namespace Rivals.Common.Systems
{
	...
	public class DownedSystemIllusio : ModSystem
	{
		public static bool downedIllusio = false;
		...
		{
			downedIllusio = tag.ContainsKey("downedIllusio");
