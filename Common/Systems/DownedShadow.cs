...
namespace Rivals.Common.Systems
{
	...
	public class DownedShadow : ModSystem
	{
		public static bool downedShadow = false;
		...
		{
			downedShadow = tag.ContainsKey("downedShadow");
